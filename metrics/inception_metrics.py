...
class MultiInceptionMetrics(Metric):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if isinstance(feature, int):
            ...
            num_features = self.inception(dummy_image)[0].shape[-1]
        else:
    ...
    def compute(self) -> Tensor:
        ...
        if self.compute_conditional_metrics:
            fake_cond_features = torch.cat(self.fake_cond_features, dim=0)
            fake_cond_logits = torch.cat(self.fake_cond_logits, dim=0)
