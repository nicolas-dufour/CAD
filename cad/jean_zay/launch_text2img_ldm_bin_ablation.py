...
cmd_modifiers = []
exps = []
num_bins = [2, 5, 10, 15, 20, 50, 100]

for bin in num_bins:
    exp_name = f"CC12m_LAION_Aesthetics_6_RIN_ldm_256_tiny_cad_bin_{bin}"
    job_name = f"cad_{bin}_ldm_tiny"
    ...
    exp_modifier = {
        ...
        "data.train_instance.num_bins": bin,
    }
