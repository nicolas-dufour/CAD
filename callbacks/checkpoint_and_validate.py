...
class ModelCheckpointValidate(ModelCheckpoint):
    ...
    def validate_on_cluster(self, checkpoint_name, file_name):
        raise NotImplementedError(
            "This method should be implemented in the subclass such as it launch a validation job on your cluster for the current checkpoint"
        )
